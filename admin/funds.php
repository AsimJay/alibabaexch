            ...
            $('#balanceTable').DataTable({
                ...
                "columns": [{
                    ...
                    },
                    {
                        "data": null,
                        "render": function(data, type, row) {
                            var addFundsButton = '<a href="addFunds.php?userId=' + row.dealerID + '" class="btn btn-info">Add Funds</a>';
                            var withdrawFundsButton = '<a href="withdrawFunds.php?userId=' + row.dealerID + '" class="btn btn-danger">Withdraw Funds</a>';
