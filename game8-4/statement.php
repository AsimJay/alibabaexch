    ...
    <div class="container">
        ...
        <table id="transactionTable" class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                // If form is submitted, update the query with the date range
                ...
                // Fetch transactions from the 'game8-4' database
                $result = mysqli_query($gameCon, $query);
                // Loop through the transactions and display them in the table
                while ($row = mysqli_fetch_assoc($result)) {
                    // Fetch the user's details from 'lottery_web' database using the user_id
                    $userId = $row['user_id'];
                    ...
                    echo "<td>" . $user['name'] . "</td>"; // User's name from 'lottery_web' database
