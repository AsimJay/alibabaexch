...
function redirect(){
    ...
    //     echo "<script>
    //     setTimeout(function() { 
    //         window.location.href = 'https://" . $_SERVER['HTTP_HOST'] . "/kainchi.php/?gameData=" . $gameDB . "';
    //     }, 0);
    //   </script>";
...
<head>
    ...
    <title>Alibaba Exchange - Kainchi</title>
</head>
<body>
<style>
        ...
        <form id="form">
            <select id="game" required>
                ...
                <?php
                    ...
                    }else if (isset($_GET['gameDB'])){
                        $gameDB = $_GET['gameDB'];
                        $gameDB = 'u423067381_' . $gameDB;
                        $game = $gameDB;
                        // echo $gameDB;
                        echo "<option value=". $gameDB ." selected>". $games[$gameDB] ."</option>";
                        }
                ?>
            ...
            <input type="number" id="number" inputmode="numeric" pattern="[0-9]*" placeholder="Enter Digits" required>
    ...
    <script>
        ...
        document.getElementById('form').addEventListener('submit', function (event) {
            ...
            let combo = generateCombinations(number.value);
    ...
    function generateURL(id, game, digits, price){
        let URL = "kTransaction.php?userID=" + encodeURIComponent(id) +"&game=" + encodeURIComponent(game.value) + "&number=" + encodeURIComponent(digits) + "&price=" + encodeURIComponent(price.value);
        return URL;
    }
    </script>
    <script>
        ...
        games.forEach(game => {
            ...
            link.href = `/kainchi.php?gameData=${game.value}`; // Replace '/your-script.php' with your PHP file path
