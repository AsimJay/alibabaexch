...
<head>
    ...
    <title>Alibaba Exchange - Multi Open</title>
</head>
<body>
<style>
    ...
    <div class="container">
        ...
        <form id="form">
            ...
            <input type="text" id="digitsInput" inputmode="numeric" placeholder="Enter Digits Separated by Comma (1, 5, 8, 2)" required>
    ...
    function generateURL(id, game, digits, price){
        let URL = "oTransaction.php?userID=" + encodeURIComponent(id) +"&game=" + encodeURIComponent(game.value) + "&number=" + encodeURIComponent(digits) + "&price=" + encodeURIComponent(price.value);
        return URL;
    }
    </script>
...
<script>
        ...
        games.forEach(game => {
            ...
            link.href = `/multiOpen.php?gameData=${game.value}`; // Replace '/your-script.php' with your PHP file path
