...
<body>
    ...
    <div class="div">
        <h2 class="heading2 text-center">Alibaba-4</h2>
        <br>
            <div class="btn-group btn-group-toggle mb-3 d-flex justify-content-center" >
                <a class="btn btn-primary active" href="./2digit.php">
                    <input type="radio"> Double
                </a>
                <a class="btn btn-primary" href="./fdigit.php">
                    <input type="radio"> Open
                </a>
                <a class="btn btn-primary" href="./sdigit.php">
        ...
        <div class="row">
            <div class="col section1 text-center">
                ...
                <!-- <p class="subHeading2">2-Digit Numbers</p> -->
                <div class="numbersContainer" id="numberContainer">
        ...
        <div class="col">
            ...
            <div class="numbersContainer">
                <?php
                // $gameCon = new mysqli('localhost', 'root', '', 'game1-4');
                $gameCon= new mysqli('localhost', 'u423067381_game1_4', 'Asim123$', 'u423067381_game1_4');
    ...
    <script>
        ...
        function minusAmountRequest(id, amount, number) {
            console.log('transaction.php?userId=' + id + '&amount=' + amount + '&number=' + number + '&digit=2')
            var xhr = new XMLHttpRequest();
            xhr.open('GET', 'transaction.php?userId=' + id + '&amount=' + amount + '&number=' + number + '&digit=2', true);
