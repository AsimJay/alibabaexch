...
<body>
    ...
    <div class="container">
        <h2>Close - <span><?php echo $game; ?></span></h2>
        ...
        <form class="form-inline">
            <div class="form-group mr-2">
                ...
                <select id="gameSelect" class="form-control ml-2">
                  <option value="./sbids.php?selected_db=asmitixc_lottery_web">Alibaba Exchange</option>
                  <option value="./sbids.php?selected_db=asmitixc_game1">Alibaba-1</option>
                  <option value="./sbids.php?selected_db=asmitixc_game2">Alibaba-2</option>
                  <option value="./sbids.php?selected_db=asmitixc_game3">Alibaba-3</option>
                  <option value="./sbids.php?selected_db=asmitixc_game4">Gm</option>
                  <option value="./sbids.php?selected_db=asmitixc_game5">Ls-1</option>
                  <option value="./sbids.php?selected_db=asmitixc_game6">Ls-2</option>
                  <option value="./sbids.php?selected_db=asmitixc_game7">Ls-3</option>
                </select>
            </div>
        </form>
        ...
        <table id="transactionTable" class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                $query = "SELECT * FROM {$selectedDatabase}.secondbiddetails AS t 
...
if (!$result) {
    ...
    <script>
      ...
      <?php
        ...
        if ($selected_db) {
          echo '$("#gameSelect").val("./sbids.php?selected_db=' . $selected_db . '");';
        }
      ?>
    });
