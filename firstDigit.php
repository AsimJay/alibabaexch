...
<body>
    ...
    <br>
    <h1 style="font-weight: bold;">Purchase First Digit</h1>
    ...
    <h1 class="text-center mt-5 font-weight-bold">First Digit Purchased Numbers</h1>
    ...
    <script>
        ...
        function minusAmountRequest(id, amount, number) {
            // console.log('firstDigitMinus.php?userId=' + id + '&amount=' + amount + '&number=' + number);
            var xhr = new XMLHttpRequest();
            xhr.open('GET', 'firstDigitMinus.php?userId=' + id + '&amount=' + amount + '&number=' + number, true);
