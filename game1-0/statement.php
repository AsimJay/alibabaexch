        ...
        <table id="transactionTable" class="table table-striped table-bordered">
           ...
           <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                // Determine if the transaction is debit or credit and adjust the amount accordingly
                $transactionType = $row['transaction_type'] == 'Spend' ? 'Debit' : 'Credit';
                $amount = $row['transaction_type'] == 'Spend' ? '-' . $row['amount'] : $row['amount'];
