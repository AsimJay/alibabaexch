...
$connection = new mysqli('localhost', 'u423067381_lottery_web', 'Asim123$', 'u423067381_lottery_web');
...
if (mysqli_stmt_fetch($stmt)) {
  if ($game2Value == '0') {
    $previousPageURL = "javascript:history.go(-1);"; // Default URL if no referrer is available
