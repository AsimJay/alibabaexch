...
<body>
    ...
    <div class="container">
        ...
        <table id="transactionTable" class="table table-striped table-bordered">
            ...
            <tbody>
            <?php
            // Connection for the 'game7' database
            $gameCon = new mysqli('localhost', 'u423067381_game7', 'Asim123$', 'u423067381_game7');
            if (mysqli_connect_errno()) {
                echo "Failed to connect to MySQL (game7): " . mysqli_connect_error();
                exit();
            }
            ...
            // Execute the transactions query on the 'game7' database
