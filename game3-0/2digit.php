...
<body>
    ...
    <div class="div">
        <h2 class="heading2 text-center">Ak Close</h2>
        <br>
        <div class="">
            <div class="btn-group btn-group-toggle mb-3 d-flex justify-content-center" >
                <!--<a class="btn btn-secondary active" id="numberBtn" href="2digit.php">-->
                <!--    <input type="radio"> Double-->
                <!--</a>-->
                <!--<a class="btn btn-secondary" id="numberBtn" href="fdigit.php">-->
                <!--    <input type="radio"> Open-->
                <!--</a>-->
                <a class="btn btn-secondary" id="numberBtn" href="sdigit.php">
        ...
        <div class="col">
            ...
            <div class="numbersContainer">
                <?php
                // $gameCon = new mysqli('localhost', 'root', '', 'game3');
                $gameCon= new mysqli('localhost', 'u423067381_game3_0', 'Asim123$', 'u423067381_game3_0');
