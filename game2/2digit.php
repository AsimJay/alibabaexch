...
<body>
    ...
    <div class="div">
        <h2 class="heading2 text-center">Alibaba 2</h2>
        <br>
        <div class="">
            <div class="btn-group btn-group-toggle mb-3 d-flex justify-content-center">
                <a class="btn btn-success active" id="numberBtn" href="2digit.php">
                    <input type="radio"> Double
                </a>
                <a class="btn btn-success" id="numberBtn" href="fdigit.php">
                    <input type="radio"> Open
                </a>
                <a class="btn btn-success" id="numberBtn" href="sdigit.php">
        ...
        <h1 class="text-center mt-5 font-weight-bold subHeading2">2-Digit Purchased Numbers</h1>
            <div class="numbersContainer">
                <?php
                // $gameCon = new mysqli('localhost', 'root', '', 'game2');
                $gameCon= new mysqli('localhost', 'u423067381_game2', 'Asim123$', 'u423067381_game2'); 
